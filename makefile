...
test-full: ensure-dev
	python -m pytest autogoal tests/core tests/contrib tests/integration --ignore=autogoal/datasets --ignore=autogoal/experimental --cov=autogoal --cov-report=term-missing -v
