...
dev-test-fast: dev-ensure
	...
	python -m pytest --doctest-modules --ignore=autogoal/contrib/torch --ignore=notebooks --ignore=examples --ignore=docs --ignore=autogoal/_old --cov=autogoal --cov-report=term-missing -v
