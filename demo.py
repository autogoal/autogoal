...
class Demo:
    ...
    def build_pipelines(self):
        ...
        from autogoal.kb._semantics import __all__ as DATA_TYPES

        types_str = DATA_TYPES
        ...
        st.write(f"**Input type**: {run_signature.parameters.values()}")
        ...
        output_type = st.selectbox(
            "Select and output type", types_str, types_str.index("VectorCategorical")
        )
        ...
        if tuples:
            input_type = f"({input_type}, Supervised[{output_type}])"
