...
@register_abstract_class
class NN_Abstract_Features(BaseAbstract, Part_Of_NN):
...
class NeuralNetwork(BaseObject, Algorithm):
    ...
    """
    def __init__(self, nn_preprocesor:NN_Preprocesor, nn_reduction:NN_Reduction, nn_abstract_features:NN_Abstract_Features, NN_Classifier:NN_Classifier):
