...
MatrixContinuous = get_data_for(Matrix, Continuous)
MatrixContinuousDense = get_data_for(Matrix, Continuous, Dense)
MatrixContinuousSparse = get_data_for(Matrix, Continuous, Sparse)
