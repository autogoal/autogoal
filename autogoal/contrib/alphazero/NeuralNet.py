...
class NeuralNetwork():
    def __init__(self, reg_const, learning_rate, game, hidden_layers):
    ...
    def train(self, examples): #examples is a list of tuples: [(board, pi, value)]
        ...
        self.model.fit(train_boards, [train_pis, train_values], batch_size=config.TRAIN_BATCH_SIZE, epochs=config.TRAIN_EPOCHS)
    ...
    def _build_model(self):
        ...
        x_image = Reshape((board_x, board_y, 1))(main_input)                # batch_size  x board_x x board_y x 1
        ...
        pi = Dense(self.output_dim, activation='softmax', name='pi')(s_fc2)   # batch_size x self.action_size
