...
# AUTOGENERATED ON 2020-01-22 22:01:46.711632
...
class SnowballStemmer(_SnowballStemmer, NltkStemmer):
    def __init__(
        self,
        language: Categorical('italian', 'romanian', 'danish', 'hungarian', 'french', 'norwegian', 'swedish', 'russian', 'english', 'spanish', 'portuguese', 'arabic', 'german', 'dutch', 'finnish')
    ):
        NltkStemmer.__init__(self)
