...
# AUTOGENERATED ON 2020-01-25 00:26:37.016822
...
class SnowballStemmer(_SnowballStemmer, NltkStemmer):
    def __init__(
        self,
        language: Categorical('french', 'english', 'finnish', 'norwegian', 'swedish', 'german', 'italian', 'spanish', 'romanian', 'russian', 'portuguese', 'danish', 'hungarian', 'dutch', 'arabic')
    ):
        NltkStemmer.__init__(self)
