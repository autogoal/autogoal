...
# AUTOGENERATED ON 2020-01-26 11:24:56.738438
...
class SnowballStemmer(_SnowballStemmer, NltkStemmer):
    def __init__(
        self,
        language: Categorical('arabic', 'norwegian', 'russian', 'swedish', 'finnish', 'german', 'italian', 'dutch', 'romanian', 'english', 'portuguese', 'spanish', 'french', 'hungarian', 'danish')
    ):
        NltkStemmer.__init__(self)
