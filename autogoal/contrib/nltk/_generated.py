...
# AUTOGENERATED ON 2020-01-11 00:58:53.585841
...
from nltk.stem.regexp import RegexpStemmer as _RegexpStemmer

class RegexpStemmer(_RegexpStemmer):
    def __init__(
        self,
        min: Discrete(min=-100, max=100)
    ):
        self.min=min
...
from nltk.tokenize.regexp import RegexpTokenizer as _RegexpTokenizer

class RegexpTokenizer(_RegexpTokenizer):
    def __init__(
        self,
        gaps: Boolean(),
        discard_empty: Boolean(),
        flags: Discrete(min=28, max=112)
    ):
        self.gaps=gaps
...
from nltk.tokenize.repp import ReppTokenizer as _ReppTokenizer

class ReppTokenizer(_ReppTokenizer):
    def __init__(
        self,
