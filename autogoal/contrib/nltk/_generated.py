...
# AUTOGENERATED ON 2020-01-23 01:06:40.242252
...
class Cistem(_Cistem, NltkStemmer):
    ...
    def run(self, input: List(List(Word()))) -> List(List(Stem())):
...
class SnowballStemmer(_SnowballStemmer, NltkStemmer):
    def __init__(
        self,
        language: Categorical('hungarian', 'swedish', 'english', 'romanian', 'finnish', 'french', 'german', 'dutch', 'italian', 'portuguese', 'danish', 'russian', 'arabic', 'spanish', 'norwegian')
    ):
        NltkStemmer.__init__(self)
...
class TweetTokenizer(_TweetTokenizer, NltkTokenizer):
    ...
    def run(self, input: List(Document())) -> List(List(Word())):
