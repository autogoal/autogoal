...
# AUTOGENERATED ON 2020-01-21 22:59:35.499960
...
class FeatureAgglomeration(_FeatureAgglomeration, SklearnTransformer):
    def __init__(
        self,
        n_clusters: Discrete(min=2, max=4),
        affinity: Categorical('euclidean'),
...
class Birch(_Birch, SklearnEstimator):
    def __init__(
        self,
        threshold: Continuous(min=0, max=1.0),
...
class MiniBatchKMeans(_MiniBatchKMeans, SklearnEstimator):
    def __init__(
        ...
        max_no_improvement: Discrete(min=0, max=20)
    ):
        SklearnEstimator.__init__(self)
...
class FactorAnalysis(_FactorAnalysis, SklearnTransformer):
    def __init__(
        ...
        iterated_power: Discrete(min=0, max=6)
    ):
        SklearnTransformer.__init__(self)
...
class KernelPCA(_KernelPCA, SklearnTransformer):
    def __init__(
        self,
        degree: Discrete(min=0, max=6),
        alpha: Continuous(min=0, max=2.0),
...
class TruncatedSVD(_TruncatedSVD, SklearnTransformer):
    def __init__(
        self,
        n_components: Discrete(min=0, max=4),
        n_iter: Discrete(min=0, max=10),
        tol: Continuous(min=-1, max=1)
    ):
        SklearnTransformer.__init__(self)
...
class ARDRegression(_ARDRegression, SklearnEstimator):
    def __init__(
        self,
        n_iter: Discrete(min=0, max=600),
        compute_score: Boolean(),
        threshold_lambda: Continuous(min=0, max=20000.0),
        fit_intercept: Boolean(),
        normalize: Boolean()
    ):
        SklearnEstimator.__init__(self)
...
class ElasticNet(_ElasticNet, SklearnEstimator):
    def __init__(
        self,
        alpha: Continuous(min=0, max=2.0),
        l1_ratio: Continuous(min=0, max=1.0),
        fit_intercept: Boolean(),
        normalize: Boolean(),
        precompute: Boolean(),
        positive: Boolean(),
...
class HuberRegressor(_HuberRegressor, SklearnEstimator):
    def __init__(
        self,
        epsilon: Continuous(min=1.0125000000000002, max=2.7),
        fit_intercept: Boolean()
    ):
        SklearnEstimator.__init__(self)
...
class Lars(_Lars, SklearnEstimator):
    def __init__(
        ...
        n_nonzero_coefs: Discrete(min=0, max=1000),
        fit_path: Boolean()
    ):
        SklearnEstimator.__init__(self)
        _Lars.__init__(
...
class Perceptron(_Perceptron, SklearnEstimator):
    def __init__(
        ...
        fit_intercept: Boolean(),
        shuffle: Boolean(),
        eta0: Continuous(min=0.5, max=2.0),
        early_stopping: Boolean(),
        n_iter_no_change: Discrete(min=2, max=10)
    ):
        SklearnEstimator.__init__(self)
...
class SGDClassifier(_SGDClassifier, SklearnEstimator):
    def __init__(
        ...
        power_t: Continuous(min=0, max=1.0),
        early_stopping: Boolean(),
        n_iter_no_change: Discrete(min=2, max=10),
        average: Boolean()
    ):
...
class RadiusNeighborsTransformer(_RadiusNeighborsTransformer, SklearnTransformer):
    def __init__(
        self,
        mode: Categorical('connectivity', 'distance'),
        radius: Continuous(min=0, max=2.0),
        algorithm: Categorical('auto', 'ball_tree', 'brute', 'kd_tree'),
        leaf_size: Discrete(min=15, max=60),
        p: Discrete(min=2, max=4)
    ):
...
class LinearSVR(_LinearSVR, SklearnEstimator):
    def __init__(
        self,
        epsilon: Continuous(min=0.0, max=1),
        C: Continuous(min=0.5, max=2.0),
        loss: Categorical('epsilon_insensitive', 'squared_epsilon_insensitive'),
        fit_intercept: Boolean(),
        intercept_scaling: Continuous(min=0.5, max=2.0),
        dual: Boolean()
    ):
        SklearnEstimator.__init__(self)
        _LinearSVR.__init__(
...
class DecisionTreeClassifier(_DecisionTreeClassifier, SklearnEstimator):
    def __init__(
        self,
        min_samples_split: Discrete(min=2, max=4),
        min_impurity_decrease: Continuous(min=0.0, max=1),
        ccp_alpha: Continuous(min=0.0, max=1)
    ):
        SklearnEstimator.__init__(self)
