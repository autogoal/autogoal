...
# AUTOGENERATED ON 2020-01-24 09:29:13.189405
...
class TheilSenRegressor(_TheilSenRegressor, SklearnEstimator):
    def __init__(
        self,
        fit_intercept: Boolean(),
        max_subpopulation: Continuous(min=1.0, max=99296.875)
    ):
        SklearnEstimator.__init__(self)
...
class Isomap(_Isomap, SklearnTransformer):
    def __init__(
        self,
        n_neighbors: Discrete(min=1, max=8),
        n_components: Discrete(min=1, max=3),
        tol: Discrete(min=-92, max=55),
