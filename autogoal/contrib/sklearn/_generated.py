# AUTOGENERATED ON 2020-01-30 14:19:30.854756
...
class AffinityPropagation(_AffinityPropagation, SklearnEstimator):
    def __init__(self, convergence_iter: Discrete(min=1, max=29)):
...
class FeatureAgglomeration(_FeatureAgglomeration, SklearnTransformer):
    def __init__(
        self, n_clusters: Discrete(min=1, max=3), compute_full_tree: Categorical("auto")
    ):
        SklearnTransformer.__init__(self)
        _FeatureAgglomeration.__init__(
            self, n_clusters=n_clusters, compute_full_tree=compute_full_tree
        )
...
from sklearn.decomposition._online_lda import (
