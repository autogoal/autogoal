...
> `build(self, graph, in_nodes=[], out_nodes=[], initializer=<function default_initializer at 0x7f7542d01f28>)`
...
> `make(self, initializer=<function default_initializer at 0x7f7542d01f28>)`
...
> [📝](https://github.com/autogoal/autogoal/blob/master/autogoal/grammar/_cfg.py#L328)
> `generate_cfg(self, grammar, head)`
...
> [📝](https://github.com/autogal/autogoal/blob/master/autogoal/grammar/_graph.py#L318)
