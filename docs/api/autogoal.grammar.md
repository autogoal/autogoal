...
> `build(self, graph, in_nodes=[], out_nodes=[], initializer=<function default_initializer at 0x7f053fbc8ea0>)`
...
> `make(self, initializer=<function default_initializer at 0x7f053fbc8ea0>)`
