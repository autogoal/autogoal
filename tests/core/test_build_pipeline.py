...
def test_simple_pipeline_graph():
    graph = build_pipeline_graph(input_types=(MatrixContinuousDense,)
    ...
    graph = build_pipeline_graph(input_types=(Seq[Text],)
    ...
    graph = build_pipeline_graph(input_types=(Seq[Word],)
                                 ,output_type=Document
                                 ,registry=[WordToWordAlgorithm, 
                                            TextToWordAlgorithm, 
                                            WordToWordListAlgorithm,
